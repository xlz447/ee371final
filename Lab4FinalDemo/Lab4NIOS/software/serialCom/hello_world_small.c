...
#define dataIn (volatile char *) 0x00021040
#define charReceived (volatile int *) 0x00021020
#define charSent (volatile int *) 0x00021010
#define dataOut (volatile char *) 0x00021030
#define transEnable (volatile int *) 0x00021000
#define LED (volatile char *) 0x00021050
...
//
//	  }
//		received = IORD_ALTERA_AVALON_PIO_DATA(charReceived);
